...
def _normalize_state_dict_keys(state_dict, use_module_prefix):
    normalized = {}
    for key, value in state_dict.items():
        if use_module_prefix and not key.startswith("module."):
            normalized["module." + key] = value
        elif not use_module_prefix and key.startswith("module."):
...
class DenoisingDiffusion(object):
    ...
    def load_ddm_ckpt(self, load_path, ema=False):
        ...
        model_state_dict = _normalize_state_dict_keys(
