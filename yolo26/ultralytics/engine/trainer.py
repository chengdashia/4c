...
Usage:
    $ yolo26 mode=train model=yolo26n.pt data=coco8.yaml imgsz=640 epochs=100 batch=16
"""
...
class BaseTrainer:
        ...
        try:
            ...
            if self.args.task == "classify":
                ...
                if "yaml_file" in data:
                    self.args.data = data["yaml_file"]  # for validating 'yolo26 train data=url.zip' usage
        except Exception as e:
        ...
        if resume:
            try:
                ...
                raise FileNotFoundError(
                    ...
                    "i.e. 'yolo26 train resume model=path/to/last.pt'"
                ) from e
        self.resume = resume
    ...
    def resume_training(self, ckpt):
        ...
        assert start_epoch > 0, (
            ...
            f"Start a new training without resuming, i.e. 'yolo26 train model={self.args.model}'"
        )
