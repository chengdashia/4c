...
yolo26 track model=yolo26n.pt source="https://youtu.be/LNwODJXcvt4" # Official Detect model
# yolo26 track model=yolo26n-seg.pt source="https://youtu.be/LNwODJXcvt4"  # Official Segment model
# yolo26 track model=yolo26n-pose.pt source="https://youtu.be/LNwODJXcvt4" # Official Pose model
# yolo26 track model=path/to/best.pt source="https://youtu.be/LNwODJXcvt4" # Custom trained model

# Track using ByteTrack tracker
# yolo26 track model=path/to/best.pt tracker="bytetrack.yaml"
```
...
yolo26 track model=yolo26n.pt source="https://youtu.be/LNwODJXcvt4" conf=0.1 iou=0.7 show
```
...
yolo26 track model=yolo26n.pt source="https://youtu.be/LNwODJXcvt4" tracker='custom_tracker.yaml'
```
