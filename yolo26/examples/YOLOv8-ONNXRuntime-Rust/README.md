...
yolo26 export model=yolov8m.pt format=onnx simplify dynamic
yolo26 export model=yolov8m-cls.pt format=onnx simplify dynamic
yolo26 export model=yolov8m-pose.pt format=onnx simplify dynamic
yolo26 export model=yolov8m-seg.pt format=onnx simplify dynamic
# yolo26 export model=yolov8m-obb.pt format=onnx simplify dynamic # Add OBB export if needed

# Export ONNX model with constant shapes (if dynamic shapes are not required)
# yolo26 export model=yolov8m.pt format=onnx simplify
# yolo26 export model=yolov8m-cls.pt format=onnx simplify
# yolo26 export model=yolov8m-pose.pt format=onnx simplify
# yolo26 export model=yolov8m-seg.pt format=onnx simplify
# yolo26 export model=yolov8m-obb.pt format=onnx simplify
```
